...
urlpatterns = [
    ...
    path('pdf/habilidades_pragmaticas_confirmacion/download', views.generate_pdf_hab_prag, name='pdf_hab_prag'),
    ...
    path('pdf/anamnesis_confirmacion/download', views.generate_pdf_anamnesis, name='pdf_anamnesis'),
    ...
    path('pdf/tecal_confirmacion/download', views.generate_pdf_tecal, name="pdf_tecal"),
    ...
    path('pdf/fonoaudiologica_confirmacion/download', views.generate_pdf_fonoaudiologica, name="pdf_fonoaudio"),
    ...
    path('pdf/teprosif_puntajes/download', views.generate_pdf_teprosif, name='pdf_teprosif'),
    path('pdf/stsg', views.generate_doc_stsg, name='generate_stsg'),
    path('pdf/stsg/<str:rut>', views.generate_doc_stsg, name='generate_stsg'),
    path('pdf/stsg_confirmacion/download', views.generate_pdf_stsg, name="pdf_stsg"),
]
